            ...
            <div className="max-w-5xl mx-auto px-4 md:px-6 py-8 relative z-10">
                ...
                <div className="mb-6">
                    <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-500 to-blue-900 dark:from-orange-400 dark:to-blue-700 px-6 py-2 rounded-full text-sm font-bold mb-4 shadow-xl text-white">
                        <Icon icon="mdi:handshake" className="text-xl" />
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-base">
                        <div className="flex items-center gap-2 bg-white dark:bg-gray-800 px-4 py-2 rounded-xl shadow-lg border-2 border-orange-200/50 dark:border-orange-800/30">
                            ...
                            <span className="font-semibold text-gray-700 dark:text-gray-300">19 Novembre 2023</span>
                        </div>
                        <div className="flex items-center gap-2 bg-white dark:bg-gray-800 px-4 py-2 rounded-xl shadow-lg border-2 border-blue-200/50 dark:border-blue-800/30">
                            ...
                            <span className="font-semibold text-gray-700 dark:text-gray-300">Alger, Algérie</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative rounded-3xl overflow-hidden shadow-2xl border-4 border-orange-200/50 dark:border-orange-800/30 mb-8">
                    <div className="relative h-[400px] md:h-[500px]">
                        <Image
                            src="/images/documentation/2.jpg"
                            alt="Signature Convention SARPI-CASH Assurances 2023"
                            fill
                    ...
                    <div className="p-8 md:p-12">
                        <div className="prose dark:prose-invert max-w-none">
                            <p className="text-lg text-gray-700 dark:text-gray-300 mb-8 leading-relaxed">
                                Le Président Directeur Général <strong className="text-blue-900 dark:text-orange-300">M. Tarik NOUIZI</strong> et 
                                la Présidente Directrice Générale de la CASH Assurances <strong className="text-blue-900 dark:text-orange-300">Mme Wided BELHOUCHET</strong> ont 
                                procédé, le dimanche 19 novembre 2023, à la signature d'une convention globale d'assurance. La CASH Assurances 
                                apportera une assistance à SARPI dans la gestion et expertise des risques et dommages, les risques industriels 
                                divers et la formation des cadres chargés de la gestion de contrat d'assurance.
                            </p>
                            ...
                            <div className="bg-gradient-to-br from-blue-50 to-orange-50/50 dark:from-blue-900/20 dark:to-orange-900/10 border-l-4 border-gradient-to-b from-orange-500 to-blue-900 rounded-2xl p-8 my-8 shadow-lg relative overflow-hidden">
                                ...
                                <div className="relative z-10">
                                    ...
                                    <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                                        Ladite convention a pour objet de définir les conditions techniques et administratives 
                                        ainsi que les modalités de souscription des polices d'assurance lors de la réalisation 
                                        des projets et couvre plusieurs activités importantes :
                                    </p>
                                    
                                    <ul className="space-y-3 text-gray-700 dark:text-gray-300">
                                        <li className="flex items-start gap-3">
                                            <Icon icon="mdi:check-circle" className="text-xl text-orange-500 dark:text-orange-400 flex-shrink-0 mt-0.5" />
                                            <span>Assurance des risques de chantier et/ou tout risque montage</span>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <Icon icon="mdi:check-circle" className="text-xl text-orange-500 dark:text-orange-400 flex-shrink-0 mt-0.5" />
                                            <span>Assurance responsabilité civile du réalisateur d'ouvrage</span>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <Icon icon="mdi:check-circle" className="text-xl text-orange-500 dark:text-orange-400 flex-shrink-0 mt-0.5" />
                                            <span>Renforcement du partenariat intra-groupe SONATRACH</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="grid md:grid-cols-3 gap-6 my-10">
                                <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border-2 border-orange-200/50 dark:border-orange-800/30 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                        Expertise et assistance dans la gestion des dommages
                                    </p>
                                </div>
                                ...
                                <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border-2 border-blue-200/50 dark:border-blue-800/30 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                        Formation des cadres en gestion de contrats
                                    </p>
                                </div>
                                ...
                                <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg border-2 border-orange-200/50 dark:border-orange-800/30 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                                    ...
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                        Couverture complète des risques divers
                                    </p>
                                </div>
                            </div>
                        </div>
